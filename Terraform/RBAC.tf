...
resource "null_resource" "GrantRBAC" {
  ...
  depends_on  = [
      azurerm_synapse_workspace.synapse[0],azurerm_storage_account.storage[0], azurerm_key_vault.KeyVault,
      azurerm_linux_function_app.FunctionApp[0]
  ]
}